...
export default function App() {
  ...
  const products = [
    ...
    { title: "Car Finance", badge: "Fast Approval", desc: "Fast and easy car finance to get you on the road sooner.", icon: <Car className="w-6 h-6 text-teal-400" /> },
    ...
    { title: "Bike Finance", badge: "Easy Apply", desc: "Quick and easy motorcycle finance to get you riding sooner.", icon: <Bike className="w-6 h-6 text-teal-400" /> },
    { title: "Boat Finance", badge: "Flexible Terms", desc: "Finance your next boat or marine vessel with tailored, hassle-free loans.", icon: <Ship className="w-6 h-6 text-indigo-400" /> },
    { title: "Truck Finance", badge: "For Business", desc: "Commercial truck and vehicle finance to keep your business moving.", icon: <Truck className="w-6 h-6 text-emerald-400" /> },
    { title: "Caravan Finance", badge: "Get Exploring", desc: "Hit the road with flexible caravan finance for your next adventure.", icon: <Caravan className="w-6 h-6 text-teal-400" /> },
    { title: "Equipment Finance", badge: "Fast Finance", desc: "Finance the tools, machinery, and equipment your business needs.", icon: <Wrench className="w-6 h-6 text-indigo-400" /> }
  ];

  // Plagiarism-free dynamic copy mapping for hero views
  const heroData = {
    'Home': {
      title: "Sovereign Capital Solutions. Engineered for Growth.",
      desc: "Get access to competitive loan rates quickly and easily. Apply online today.",
      btn: "Request Loan"
    },
    'Car Loan': {
      title: "Get Quick Car Finance. Unleash the Path.",
      desc: "Fast and easy car finance to get you on the road sooner.",
      btn: "Request Loan"
    },
    'Car Finance': {
      title: "Get Quick Car Finance. Unleash the Path.",
    ...
    'Home Loan': {
      title: "Architect Your Legacy. Masterclass Mortgages.",
      desc: "Competitive mortgage rates and flexible terms to help you buy your dream home.",
      btn: "Request Loan"
    },
    'Business Loan': {
      title: "Velocity Corporate Funding. Scale Unhindered.",
      desc: "Flexible business loans up to $1,000,000 to help your company grow and succeed.",
      btn: "Request Loan"
    },
    'All Products': {
      title: "An Arbitraged Suite of Wholesale Facilities.",
      desc: "Browse our complete range of simple, straightforward loan products tailored to your needs.",
      btn: ""
    },
    'Personal Loan': {
      title: "Flexible Capital Reserves. Tailored to Moment.",
      desc: "Quick personal loans for holidays, weddings, home improvements, or debt consolidation.",
      btn: "Request Loan"
    },
    'Bike Finance': {
      title: "Recreational Fleet Finance. Ride Optimized.",
      desc: "Quick and easy motorcycle finance with competitive rates to get you riding sooner.",
      btn: "Request Loan"
    },
    'Boat Finance': {
      title: "Sovereign Yacht Portfolios. Set Sail.",
      desc: "Finance your next boat or marine vessel with our tailored, hassle-free loans.",
      btn: "Request Loan"
    },
    'Truck Finance': {
      title: "Commercial Fleet Assetting. Deploy Velocity.",
      desc: "Commercial truck and vehicle finance designed to keep your business moving forward.",
      btn: "Request Loan"
    },
    'Caravan Finance': {
      title: "Nomadic Adventure Capital. Zero Limits.",
      desc: "Hit the road with flexible caravan and camper trailer finance for your next adventure.",
      btn: "Request Loan"
    },
    'Equipment Finance': {
      title: "Bespoke Equipment Underwriting. Expand Workspaces.",
      desc: "Finance the tools, machinery, and equipment your business needs to operate efficiently.",
      btn: "Request Loan"
    }
  };
  ...
  const handleWizardSubmit = () => {
    if (wizardStep < 4) {
      ...
      const subject = encodeURIComponent(`Capital Qualification Request - ${wizardName}`);
      const body = encodeURIComponent(
        `Dear @money Capital Panel,\n\nI am requesting pre-qualification for a wholesale loan facility.\n\n` +
        `Facility Request: $${wizardAmount.toLocaleString()}\n` +
        `Purpose: ${wizardPurpose}\n` +
        `Applicant Name: ${wizardName}\n` +
        `Email Coordinates: ${wizardEmail}\n` +
        `Contact Phone: ${wizardPhone}\n` +
        `Employment State: ${wizardEmployment}\n\n` +
        `Please match my profile with appropriate Tier-1 and Tier-2 underwriting panels.\n\nRegards,\n${wizardName}`
      );
      
      setWizardSuccessMsg("MATCH dossier initialized! Opening client email coordinator...");
      setTimeout(() => {
        window.location.href = `mailto:contact@money.com.au?subject=${subject}&body=${body}`;
        setWizardStep(5);
      }, 1200);
    }
  };
  ...
  const renderInteractiveMockup = (tab) => {
    ...
    if (tab === 'Business Loan' || tab === 'Equipment Finance') {
      return (
        <div className="w-full relative rounded-2xl border border-emerald-500/20 bg-slate-950/70 p-6 backdrop-blur-xl shadow-2xl shadow-emerald-500/5">
          <div className="flex justify-between items-center mb-6 border-b border-white/5 pb-4">
            <div className="flex items-center space-x-2">
              <Landmark className="w-4 h-4 text-emerald-400" />
              <span className="text-[11px] font-bold tracking-widest text-emerald-400 uppercase">Velocity Facility Console</span>
            </div>
            <span className="text-[10px] bg-emerald-500/10 border border-emerald-500/20 text-emerald-400 px-2 py-0.5 rounded-full font-bold">Active Panel</span>
          </div>

          <div className="grid grid-cols-2 gap-4 mb-6">
            <div className="rounded-xl border border-white/5 bg-slate-900/50 p-4">
              <span className="text-[9px] text-slate-400 font-bold uppercase tracking-widest block mb-1">Total Limit Pool</span>
              <span className="text-xl font-black text-white">$1,000,000</span>
            </div>
            <div className="rounded-xl border border-white/5 bg-slate-900/50 p-4">
              <span className="text-[9px] text-slate-400 font-bold uppercase tracking-widest block mb-1">Available Capital</span>
              <span className="text-xl font-black text-emerald-400">${(1000000 - businessDrawdownVal).toLocaleString()}</span>
            </div>
          </div>

          <div className="mb-6">
            <div className="flex justify-between mb-2">
              <span className="text-xs text-slate-300 font-bold">Slide to Draw Capital:</span>
              <span className="text-xs text-indigo-400 font-black">${businessDrawdownVal.toLocaleString()}</span>
            </div>
            <input 
              type="range" 
              min="50000" 
              max="950000" 
              step="25000" 
              value={businessDrawdownVal} 
              onChange={(e) => { setBusinessDrawdownVal(Number(e.target.value)); setDrawdownDispatched(false); }}
              className="slider-custom w-full cursor-pointer"
            />
          </div>

          {/* SVG Animated line curve simulation based on slider */}
          <div className="h-16 rounded-lg bg-slate-900/60 border border-white/5 p-2 flex items-end justify-between relative overflow-hidden mb-4">
            <svg className="absolute bottom-0 left-0 w-full h-full text-emerald-500/10 pointer-events-none" viewBox="0 0 100 100" preserveAspectRatio="none">
              <path d={`M0,100 C30,${100 - (businessDrawdownVal/15000)} 70,${90 - (businessDrawdownVal/10000)} 100,100 L100,100 L0,100 Z`} fill="currentColor" />
              <path d={`M0,100 C30,${100 - (businessDrawdownVal/15000)} 70,${90 - (businessDrawdownVal/10000)} 100,100`} fill="none" stroke="#10B981" strokeWidth="2" />
            </svg>
            <span className="text-[8px] text-slate-500 font-bold z-10">Cashflow Yield Curve Matrix</span>
          </div>

          {drawdownSpinning ? (
            <div className="w-full py-3 rounded-xl bg-indigo-600 flex items-center justify-center space-x-2">
              <div className="w-4 h-4 border-2 border-white border-t-transparent rounded-full animate-spin"></div>
              <span className="text-xs font-bold text-white">Processing Request...</span>
            </div>
          ) : drawdownDispatched ? (
            <div className="w-full py-3 rounded-xl bg-emerald-950/60 border border-emerald-500/30 text-emerald-400 text-center text-xs font-bold">
              ⚡ Funds Dispatched - Ref #{(businessDrawdownVal * 17).toString(16).toUpperCase()} Verified
            </div>
          ) : (
            <button 
              onClick={triggerDrawdown}
              className="w-full py-3 rounded-xl bg-emerald-500 text-slate-950 font-bold text-xs hover:bg-emerald-400 transition-all text-center tracking-wider uppercase"
            >
              Simulate Drawdown
            </button>
          )}
    ...
    return (
      <div className="w-full relative rounded-2xl border border-indigo-500/20 bg-slate-950/70 p-6 backdrop-blur-xl shadow-2xl shadow-indigo-500/5">
        <div className="flex justify-between items-center mb-6">
          <span className="text-[11px] font-black tracking-widest text-indigo-400 uppercase">Underwriter Risk Engine</span>
        ...
        <div className={`w-full aspect-[1.7/1] rounded-2xl p-5 relative overflow-hidden transition-all duration-700 ${
          ...
          <div className="text-[10px] text-slate-400 font-bold uppercase tracking-widest mb-1">Pre-Approved Capital Allocation</div>
          ...
          <div className="flex justify-between items-end mt-4">
            <div className="flex flex-col">
              <span className="text-[8px] text-slate-500 font-black uppercase tracking-wider">APR Tier Quote</span>
        ...
        <p className="text-[10px] text-slate-400 italic text-center mt-4">
          *Real-time assessment model computed using soft pulls. Absolutely no bureau scoring impact.
        </p>
      </div>
    );
  };
      ...
      {activeTab === 'Request Loan' ? (
          ...
          <div className="rounded-3xl border border-indigo-500/20 bg-slate-950/60 p-8 md:p-12 backdrop-blur-2xl shadow-2xl shadow-indigo-500/5 relative overflow-hidden">
            ...
            <div className="mb-10">
              <div className="flex justify-between items-center text-[10px] uppercase font-bold tracking-widest text-slate-400 mb-3">
                <span>Phase {wizardStep} of 5</span>
            ...
            {wizardStep === 1 && (
              <div className="space-y-8">
                <div>
                  ...
                  <p className="text-slate-400 text-sm">Select a loan type, amount, and repayment tenure. We'll tailor the next steps automatically.</p>
                </div>
                ...
                <div className="space-y-7">
                  ...
                  <div className="space-y-4">
                    <div className="flex justify-between items-baseline">
                      <span className="text-[10px] text-slate-400 uppercase tracking-widest font-black">Repayment Tenure</span>
                      ...
                      <div className="sm:col-span-2">
                        <div className="rounded-2xl border border-white/5 bg-slate-900/40 p-4 h-full flex items-center justify-between">
                          <div>
                            ...
                            <div className="text-xs text-slate-300 font-semibold mt-1">Longer tenure lowers repayments but increases total interest.</div>
                          </div>
            ...
            {wizardStep === 2 && (
              <div className="space-y-8">
                <div>
                  ...
                  <p className="text-slate-400 text-sm">This helps route your request to the right underwriting team. Keep it short.</p>
                </div>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  {[
                    { label: 'Purchase / New', desc: 'New purchase, new asset, or first-time facility.' },
                    { label: 'Refinance', desc: 'Replace an existing loan or restructure terms.' },
                    { label: 'Cashflow / Working Capital', desc: 'Bridge gaps, inventory, payroll, or invoices.' },
                    { label: 'Consolidation / Other', desc: 'Combine liabilities or a custom requirement.' }
                  ].map(pur => (
                    <button
                      key={pur.label}
            ...
            {wizardStep === 3 && (
              <div className="space-y-8">
                <div>
                  <h2 className="text-2xl md:text-3xl font-black text-white tracking-tight mb-2">Pre-Qualification Coordinates.</h2>
                  <p className="text-slate-400 text-sm">Provide credentials to coordinate underwriting matches.</p>
                </div>
                ...
                <div className="space-y-5">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      <div>
                        <label className="text-[10px] text-slate-400 uppercase font-black tracking-widest block mb-2">Secure Email Address</label>
                        <input 
                          type="email" 
                          value={wizardEmail}
                      ...
                      <div>
                        <label className="text-[10px] text-slate-400 uppercase font-black tracking-widest block mb-2">Contact Mobile Coordinates</label>
                        <input 
                          type="tel" 
                          value={wizardPhone}
            ...
            {wizardStep === 4 && (
              <div className="space-y-8">
                <div>
                  <h2 className="text-2xl md:text-3xl font-black text-white tracking-tight mb-2">Underwriting Feasibility Dossier.</h2>
                  <p className="text-slate-400 text-sm">Our real-time analyzer assessed your parameters. Review your prospectus summary.</p>
                </div>
                
                <div className="rounded-2xl border border-white/5 bg-slate-900/50 p-6 space-y-4">
                  <div className="flex justify-between items-center pb-3 border-b border-white/5">
                    <span className="text-xs text-slate-400 uppercase tracking-widest font-bold">Client Target</span>
                    <span className="text-sm font-black text-white">{wizardName || 'Prospect'}</span>
                  </div>
                  <div className="flex justify-between items-center pb-3 border-b border-white/5">
                    <span className="text-xs text-slate-400 uppercase tracking-widest font-bold">Facility Requested</span>
                    <span className="text-sm font-black text-emerald-400">${wizardAmount.toLocaleString()}</span>
                  </div>
                  <div className="flex justify-between items-center pb-3 border-b border-white/5">
                    <span className="text-xs text-slate-400 uppercase tracking-widest font-bold">Strategic Purpose</span>
                    <span className="text-sm font-black text-indigo-400">{wizardPurpose}</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-xs text-slate-400 uppercase tracking-widest font-bold">Feasibility Index Rating</span>
                    <div className="flex items-center space-x-1.5">
                      <div className="w-2.5 h-2.5 rounded-full bg-emerald-500 animate-pulse"></div>
                      <span className="text-xs font-black text-emerald-400 uppercase tracking-wider">Optimal Match - Tier-1 Qualified</span>
                    </div>
                  </div>
                </div>
            ...
            {wizardStep === 5 && (
              <div className="text-center py-10 space-y-6">
                ...
                <div className="space-y-2">
                  <h2 className="text-3xl font-black text-white tracking-tight">Prospectus Deployed Successfully.</h2>
                  <p className="text-slate-400 text-sm max-w-md mx-auto leading-relaxed">
                    We have successfully packaged your pre-qualification data and matched your coordinates with the top 3 lenders on our panel.
                  </p>
                </div>
                <button
        ...
        <section className="py-16 md:py-24 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
          <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
            <div className="inline-flex items-center space-x-1.5 px-3 py-1 rounded-full border border-indigo-500/20 bg-indigo-500/5">
              ...
              <span className="text-[10px] font-black uppercase tracking-widest text-indigo-300">Get In Touch</span>
            </div>
            <h1 className="text-4xl md:text-5xl font-black text-white tracking-tight leading-none">Connect With Our Panel.</h1>
            <p className="text-slate-400 text-lg leading-relaxed">
              Reach out to our expert brokers for direct access to wholesale capital and bespoke credit facilities.
            </p>
          </div>
        ...
        <section className="py-16 md:py-24 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
          <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
            ...
            <h1 className="text-4xl md:text-5xl font-black text-white tracking-tight leading-none">Architecting the Future of Credit.</h1>
            <p className="text-slate-400 text-lg leading-relaxed">
              We arbitrate the wholesale credit markets to deliver elite private pricing directly to your screen, eliminating retail friction.
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center mb-20">
            <div className="space-y-6">
              ...
              <p className="text-slate-400 text-sm leading-relaxed">
                At @money Capital, we believe that access to high-tier capital shouldn't be restricted by legacy banking bureaucracy. Our mission is to democratize institutional-grade lending, providing both businesses and individuals with the leverage they need to scale.
              </p>
              <p className="text-slate-400 text-sm leading-relaxed">
                By integrating directly with over 40+ wholesale capital providers, our proprietary engine matches your specific profile to the optimal lending panel, ensuring you receive the most competitive rates and terms in the market.
              </p>
              <ul className="space-y-3 pt-4">
                {[
                  "Direct Access to Wholesale Rates",
                  "Algorithmic Panel Matching",
                  "Absolute Data Privacy & Security",
                  "Unbiased Financial Structuring"
                ].map((item, i) => (
              ...
              <div className="glass-panel rounded-3xl p-8 relative border border-white/10 shadow-2xl bg-slate-900/40">
                <div className="grid grid-cols-2 gap-4">
                  <div className="bg-slate-950/50 rounded-2xl p-6 border border-white/5 text-center">
                    ...
                    <span className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">Capital Deployed</span>
                  </div>
                  <div className="bg-slate-950/50 rounded-2xl p-6 border border-white/5 text-center">
        ...
        <section className="py-16 md:py-24 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
          <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
            ...
            <p className="text-slate-400 text-lg leading-relaxed">
              Join the @money Capital broker panel. Access wholesale liquidity and premium commission structures designed for top-tier professionals.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-16">
            {[
              { icon: <TrendingUp className="w-6 h-6 text-emerald-400" />, title: "Premium Yields", desc: "Earn industry-leading upfront commissions up to 1.25% with transparent trail structures." },
              { icon: <Sparkles className="w-6 h-6 text-indigo-400" />, title: "Wholesale Access", desc: "Bypass retail friction. Connect directly to 40+ institutional lenders and private credit funds." },
            ].map((benefit, i) => (
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-start">
            ...
            <div className="glass-panel rounded-3xl p-8 lg:p-10 border border-white/5 bg-slate-900/40 shadow-2xl relative overflow-hidden">
              ...
              <h3 className="text-2xl font-black text-white mb-2">Request Accreditation</h3>
              <p className="text-slate-400 text-xs mb-8">Submit your details below to initialize the accreditation process with our compliance team.</p>
              
              <form className="space-y-5" onSubmit={(e) => { e.preventDefault(); alert("Accreditation request submitted successfully!"); }}>
        ...
        <section className="py-16 md:py-24 px-4 sm:px-6 lg:px-8 max-w-5xl mx-auto">
          <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
            ...
            <p className="text-slate-400 text-lg leading-relaxed">
              Transparent operations and institutional-grade compliance. Review our core policies and regulatory standing.
            </p>
          </div>
          ...
          <div className="space-y-6">
            <div className="glass-panel rounded-2xl p-8 border border-white/5 bg-slate-900/40 space-y-4">
              ...
              <p className="text-slate-400 text-sm leading-relaxed">
                By accessing @money Capital’s digital infrastructure, you agree to comply with our commercial terms. Our platform serves as an algorithmic conduit matching capital requests with wholesale credit providers. We do not directly issue credit unless explicitly stated in separate commercial documentation.
              </p>
            </div>
            <div className="glass-panel rounded-2xl p-8 border border-white/5 bg-slate-900/40 space-y-4">
              ...
              <p className="text-slate-400 text-sm leading-relaxed">
                Data sovereignty is absolute. We employ SSL encryption and adhere to ISO 27001 standards. Your personal and corporate intelligence is solely utilized for the purpose of credit arbitration and will never be commercially distributed to unauthorized retail agencies.
              </p>
            </div>
            <div className="glass-panel rounded-2xl p-8 border border-white/5 bg-slate-900/40 space-y-4">
        ...
        <section className="py-16 md:py-24 px-4 sm:px-6 lg:px-8 max-w-5xl mx-auto">
          <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
            <div className="inline-flex items-center space-x-1.5 px-3 py-1 rounded-full border border-teal-500/20 bg-teal-500/5">
              ...
              <span className="text-[10px] font-black uppercase tracking-widest text-teal-300">Underwriting Credentials</span>
            </div>
            <h1 className="text-4xl md:text-5xl font-black text-white tracking-tight leading-none">Standard Document Checklist.</h1>
            <p className="text-slate-400 text-lg leading-relaxed">
              Expedite your wholesale qualification. Prepare the following digital dossiers prior to triggering your formal application.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="glass-panel rounded-2xl p-8 border border-white/5 bg-slate-900/40">
              ...
              <h3 className="text-xl font-black text-white mb-4">Consumer Facilities</h3>
              <p className="text-slate-400 text-xs mb-6">For personal loans, home loans, and standard car finance.</p>
            ...
            <div className="glass-panel rounded-2xl p-8 border border-white/5 bg-slate-900/40">
              ...
              <h3 className="text-xl font-black text-white mb-4">Commercial Facilities</h3>
              <p className="text-slate-400 text-xs mb-6">For business loans, heavy equipment, and fleet financing.</p>
              <ul className="space-y-4">
                {[
          ...
          <div className="mt-12 p-6 rounded-2xl border border-dashed border-white/10 bg-slate-950/40 text-center">
             <p className="text-sm text-slate-400 font-medium">All documents can be securely uploaded via our encrypted client portal upon initiating a quote.</p>
             <button 
                onClick={() => { setActiveTab('Request Loan'); window.scrollTo({ top: 0, behavior: 'smooth' }); }}
        ...
        <>
              ...
              {activeTab === 'All Products' ? (
                <div className="text-center max-w-3xl mx-auto space-y-6">
                  <div className="inline-flex items-center space-x-1.5 px-3 py-1 rounded-full border border-emerald-500/20 bg-emerald-500/5">
                    ...
                    <span className="text-[10px] font-black uppercase tracking-widest text-emerald-300">Financial Ecosystem</span>
                  </div>
                  ...
                  <div className="space-y-8">
                    <div className="inline-flex items-center space-x-1.5 px-3 py-1 rounded-full border border-emerald-500/20 bg-emerald-500/5">
                      ...
                      <span className="text-[10px] font-black uppercase tracking-widest text-emerald-300">
                        {activeTab === 'Home' ? 'Fintech Arbitrage Engine' : `${activeTab} Bracket`}
                      </span>
                    </div>
          ...
          {(activeTab === 'All Products' || activeTab === 'Home') && (
            <section className="py-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
              <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
                <span className="text-[10px] font-black uppercase tracking-widest text-emerald-400">Panel Scope</span>
                <h2 className="text-3xl md:text-4xl font-black text-white tracking-tight">Arbitraged Underwriting Brackets</h2>
                <p className="text-slate-400 text-sm leading-relaxed">
                  We maintain strategic digital integrations with over 40+ wholesale capital providers. Select a lending bracket to see target terms.
                </p>
              </div>
          ...
          <section id="calculator" className="py-20 px-4 sm:px-6 lg:px-8 border-t border-white/5 bg-slate-950/40 relative">
            <div className="max-w-5xl mx-auto">
              ...
              <div className="text-center mb-12 space-y-4">
                <span className="text-[10px] font-black uppercase tracking-widest text-emerald-400">Amortization Engine</span>
                <h2 className="text-3xl font-black text-white tracking-tight">Interactive Cost Modeling</h2>
                <p className="text-slate-400 text-sm max-w-md mx-auto">
                  Adjust standard sliders to estimate regular wholesale yield costs. Switch intervals or inspect repayment timelines below.
                </p>
              </div>
              ...
              <div className="glass-panel rounded-3xl p-8 lg:p-12 border border-white/5 shadow-2xl relative overflow-hidden">
                <div className="grid lg:grid-cols-2 gap-12 items-center">
                  ...
                  <div className="space-y-8 lg:pr-8 lg:border-r border-white/5">
                    ...
                    <div className="space-y-3">
                      <div className="flex justify-between items-baseline">
                        <label className="text-xs font-bold text-slate-400 uppercase tracking-wider">Loan Principal Bracket ($)</label>
                    ...
                    <div className="space-y-3">
                      <div className="flex justify-between items-baseline">
                        <label className="text-xs font-bold text-slate-400 uppercase tracking-wider">Lending Maturity Bracket (Years)</label>
                    ...
                    <div className="space-y-3">
                      <div className="flex justify-between items-baseline">
                        <label className="text-xs font-bold text-slate-400 uppercase tracking-wider">Arbitraged Interest Rate (% p.a.)</label>
                    ...
                    <div className="space-y-3">
                      <div className="flex justify-between items-baseline">
                        <label className="text-xs font-bold text-slate-400 uppercase tracking-wider">Simulate Extra Monthly Repayment ($)</label>
                ...
                {isCalcScheduleOpen && (
                  <div className="border-t border-white/5 mt-10 pt-8 animate-[pulse-soft_1s_ease-out_1]">
                    <h3 className="text-sm font-black text-white uppercase tracking-wider mb-4 flex items-center">
                      <TrendingUp className="w-4 h-4 mr-2 text-emerald-400" /> Milestone Amortization Projections
                    </h3>
              ...
              <p className="text-[10px] text-slate-500 text-center mt-6 max-w-3xl mx-auto leading-relaxed">
                *The computations provided above are structured simulations. Interest indexes and credit brackets vary dynamically. Connect with an accredited panel advisor for verified offer packets. Australian Credit License #547719.
              </p>
            </div>
          </section>
              ...
              <div className="grid lg:grid-cols-2 gap-16 items-center">
                ...
                <div className="space-y-8">
                  ...
                  <p className="text-slate-400 text-base leading-relaxed">
                    We invite boutique finance professionals, corporate credit advisors, and mortgage packagers to interface directly with our proprietary wholesale suite. Access dynamic tools and deep institutional liquidity immediately.
                  </p>
                ...
                <div className="rounded-3xl border border-indigo-500/20 bg-slate-950/70 p-8 backdrop-blur-xl shadow-2xl">
                  ...
                  <div className="space-y-6">
                    <div className="space-y-2">
                      <div className="flex justify-between items-baseline">
                        <label className="text-xs font-bold text-slate-300 uppercase tracking-wider">Settled Monthly Pool Volume</label>
            ...
            <div className="rounded-[2.5rem] border border-white/5 bg-gradient-to-br from-slate-950 via-slate-900/30 to-slate-950 p-10 lg:p-16 relative overflow-hidden shadow-2xl">
              ...
              <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center mb-16 relative z-10">
                <div className="max-w-2xl mb-8 lg:mb-0 space-y-3">
                  <span className="text-[10px] font-black uppercase tracking-widest text-emerald-400">Governance</span>
                  <h3 className="text-3xl md:text-4xl font-black text-white tracking-tight leading-none">Uncompromised Transaction Safeguards.</h3>
                  <p className="text-slate-400 text-sm leading-relaxed">
                    Deploying clean capital strategies and reliable pre-approvals on every commercial and consumer contract.
                  </p>
                </div>
                <button 
                  onClick={() => { setActiveTab('Request Loan'); window.scrollTo({ top: 0, behavior: 'smooth' }); }}
              ...
              <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-8 relative z-10">
                <div className="space-y-2">
                  ...
                  <h5 className="text-xs font-black text-white uppercase tracking-wider">Trusted Coordinates</h5>
                  <p className="text-slate-400 text-xs leading-normal">Satisfied borrowers matching objectives through our arbitraged wholesale pipeline.</p>
                </div>
                <div className="space-y-2">
                  <span className="text-3xl lg:text-4xl font-black text-indigo-400 block tracking-tight">$73M Facility</span>
                  <h5 className="text-xs font-black text-white uppercase tracking-wider">Record Drawdown</h5>
                  <p className="text-slate-400 text-xs leading-normal">Successfully structured and settled high-value institutional capital pipelines.</p>
                </div>
                <div className="space-y-2">
                  <span className="text-3xl lg:text-4xl font-black text-teal-400 block tracking-tight">8 Years</span>
                  <h5 className="text-xs font-black text-white uppercase tracking-wider">Panel Integrity</h5>
                  <p className="text-slate-400 text-xs leading-normal">A solid legacy of delivering reliable panel options and pristine customer yields.</p>
                </div>
                <div className="space-y-2">
                  <span className="text-3xl lg:text-4xl font-black text-emerald-400 block tracking-tight">8 Regions</span>
                  <h5 className="text-xs font-black text-white uppercase tracking-wider">National Hubs</h5>
                  <p className="text-slate-400 text-xs leading-normal">Full continental coverage tailored to comply with local credit guidelines.</p>
                </div>
              </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 mb-16">
            ...
            <div className="lg:col-span-4 space-y-6">
              ...
              <p className="text-slate-400 text-xs leading-relaxed max-w-sm">
                @money Capital coordinates direct interfaces with institutional and wholesale commercial underwriter tables. Eliminating retail friction through algorithmic design.
              </p>
